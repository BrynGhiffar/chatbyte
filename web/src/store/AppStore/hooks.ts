...
export const useSelectedContactMessages = () =>
  useAppStore(s => {
...
export const useChatListSearch = (): [string, (search: string) => void] =>
  useAppStore(s => [s.chatlistSearch, s.onChangeChatListSearch]);

export const useTheme = (): [Theme, (themeId: ThemeId) => void] =>
  useAppStore(s => [s.theme, s.setTheme]);

...
export const TH__ChatInputBar: DivWrapper = ({ children, ...props }) => {
  ...
  return (
    <SC__ChatInputBar $backgroundColor={backgroundColor} {...props}>
      {children}
    </SC__ChatInputBar>
  );
};

export const TH__UploadAttachmentButton: ButtonWrapper = ({
  children,
  ...props
}) => {
  const hoverBackgroundColor =
    useColorConfig().chatInputSendButtonBackgroundColorHover;
...
export const TH__ChatInputDecorationContainer: DivWrapper = ({
  children,
  ...props
}) => {
...
export const TH__ChatInputTextWrapper: DivWrapper = ({
  children,
  ...props
}) => {
  const borderColor = useColorConfig().chatInputBorderColor;
  return (
    <SC__ChatInputTextWrapper $borderColor={borderColor} {...props}>
      {children}
    </SC__ChatInputTextWrapper>
  );
};

export const TH__ChatInputText = forwardRef(
...
export const TH__ChatEditMessageContainer: DivWrapper = ({
  children,
  ...props
}) => {
...
export const TH__ChatEditMessageCloseButton: ButtonWrapper = ({
  children,
  ...props
}) => {
  const color = useColorConfig().chatInput.chatEditColor;
  return (
    <SC__ChatEditMessageCloseButton $color={color} {...props}>
      {children}

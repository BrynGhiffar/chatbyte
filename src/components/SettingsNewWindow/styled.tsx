...
export const SC__SidebarContainer = styled(
  VerticalStackContainer
)<SC__SidebarContainerProps>`
  padding-top: 1rem;
  padding-bottom: 1rem;
  padding-right: 1rem;
  padding-left: 1rem;
...
export type TH__SidebarItemContainerProps = PropsWithChildren<
  DivProps & {
    $selected?: boolean;
    $focusBgColor?: string;
  }
...
export type TH__SidebarContainerProps = PropsWithChildren<
  DivProps & {
    $gap?: number;
  }
>;

export const TH__SidebarContainer: FC<TH__SidebarContainerProps> = ({
  children,
  $gap,
  ...props
}) => {

...
export const TH__SidebarContainerTop: DivWrapper = ({ children, ...props }) => {
    return (
        <SC__SidebarContainerTop { ...props }>
            { children }
        </SC__SidebarContainerTop>
    )
}

export const TH__SidebarContainerBottom: DivWrapper = ({ children, ...props }) => {
    return (
...
export const TH__SidebarButton: ButtonWrapper = ({ children, ...props }) => {
    const hoverBackgroundColor = useColorConfig().sidebar.buttonBackgroundHoverColor;
    return (

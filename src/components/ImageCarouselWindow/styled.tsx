...
export const TH__ImageCarouselContainer: DivWrapper = ({
  children,
  ...props
}) => {
  return (
...
export const TH__ImageCarouselImage: BaseHTMLImgProps<{ $width: number }> = ({
  children,
  ...props
}) => {
  return <SC__ImageCarouselImage {...props} />;
};

export const TH__ImageCarouselButton: ButtonWrapper = ({
  children,
  ...props
}) => {
  const backgroundColor = useColorConfig().imageCarousel.buttonBackgroundColor;
  const iconColor = useColorConfig().imageCarousel.buttonIconColor;
  const borderColor = useColorConfig().imageCarousel.buttonBorderColor;
  return (
...
export const TH__ImageCarouselButtonContainer: DivWrapper = ({
  children,
  ...props
}) => {
  return (

...
const CustomMultiValueContainer: FC<PropsWithChildren<any>> = ({ innerProps, ...props}) => {
    return (
...
const CustomValueContainer: FC<ValueContainerProps> = ({ innerProps, ...props}) => {
    return (
...
const CustomMultiValueRemove:  FC<PropsWithChildren<any>> = ({ innerProps, ...props}) => {
    return (
        <></>
    );
};

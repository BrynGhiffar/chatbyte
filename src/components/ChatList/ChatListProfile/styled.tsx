...
export const TH__ChatListProfileContainer: DivWrapper = ({ children, ...props }) => {
...
type TH__ChatListProfileMoreButtonProps = PropsWithChildren<DivProps & { 
    $clicked?: boolean;
}>;

export const TH__ChatListProfileMoreButton: FC<TH__ChatListProfileMoreButtonProps> = ({ children, $clicked, ...props }) => {
    const hoverBackgroundColor = useColorConfig().chatListNavProfileMoreButtonHoverBackgroundColor;
    return (

...
export const TH__SeparatorBlockTitle: DivWrapper = ({ children, ...rest}) => {
    ...
    return <SC__SeparatorBlockTitle
        $color={color}
        {...rest}
    >
        {children}
...
export const TH__SeparatorBlockAddContainer: DivWrapper = ({children, ...rest}) => {
    const colorConfig = useColorConfig();
    const color = colorConfig.chatListSeparatorTextColor;
    return <SC__SeparatorBlockAddContainer
        {...rest}
        $color={color}
    >{children}</SC__SeparatorBlockAddContainer>
}